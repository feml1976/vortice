...
/**
 * Repositorio para la entidad TireSupplier del catálogo (Proveedores de llantas - Catálogo)
 *
 * @author Vórtice Development Team
 */
@Repository
public interface TireCatalogSupplierRepository extends JpaRepository<TireSupplier, UUID> {
