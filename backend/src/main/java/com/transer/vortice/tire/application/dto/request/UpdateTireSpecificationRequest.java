...
/**
 * DTO de request para actualizar una Especificación Técnica de Llanta existente
 *
...
@NoArgsConstructor
@AllArgsConstructor
public class UpdateTireSpecificationRequest {

    // El código NO se puede actualizar si ya tiene llantas asociadas
